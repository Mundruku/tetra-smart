            ...
            <div class="col-1 new-users"> 
                ...
                <div class="content">
                    ...
                    <ul class="form-list">
                       ...
                       <li>
                            <label for="pass">Full Name <em class="required">*</em></label>
                            <div class="input-box">
                                <input type="text" name="name" value="{{ old('name') }}" class="input-text required-entry validate-password @error('name') is-invalid @enderror" id="pass" title="full Name" />
                            </div>
                             @error('name')
                        ...
                        <li>
                            ...
                            <div class="input-box">
                                <input type="email" name="email" value="{{ old('email') }}" id="email" class="input-text required-entry validate-email @error('email') is-invalid @enderror" title="Email Address" />
                            </div>
                    ...
                    <ul class="form-list">
                      <li>
                         ...
                         <li>
                            ...
                            <div class="input-box">
                                <input type="password" name="password_confirmation"  class="input-text required-entry validate-password  @error('password') is-invalid @enderror" id="pass" title="Password" />
                            </div>
