...
<script type="text/javascript" src="{{asset('user/js/lib/matchMedia.addListener.js')}}"></script>


<script type="text/javascript" src="{{asset('user/js/lib/enquire.js')}}"></script>
<script type="text/javascript" src="{{asset('user/js/app.js')}}"></script>
<script type="text/javascript" src="{{asset('user/js/lib/jquery.cycle2.min.js')}}"></script>
<script type="text/javascript" src="{{asset('user/js/lib/jquery.cycle2.swipe.min.js')}}"></script>
<script type="text/javascript" src="{{asset('user/js/slideshow.js')}}"></script>
<script type="text/javascript" src="{{asset('user/js/lib/imagesloaded.js')}}"></script>
<script type="text/javascript" src="{{asset('user/js/minicart.js')}}"></script>
<script type="text/javascript" src="{{asset('user/js/countdowntimer/countdowntimer.js')}}"></script>

<script type="text/javascript" src="{{asset('user/js/lib/elevatezoom/jquery.elevateZoom-3.0.8.min.js')}}"></script>
