                     ...
                     <div class="col-xs-12 col-sm-6">
                         ...
                         <!-- <div class="dropdown block-language-wrapper">
                             ...
                             <ul role="menu" class="dropdown-menu">
                                 ...
                                 <li role="presentation"><a href="{{ route('user.logout') }}" tabindex="-1"
                                         role="menuitem">
                                         <img src="{{ asset('user/images//flags/bolt.png') }}" alt="English" />
                                         English </a></li>

                                 <li role="presentation"><a href="../boltfr/indexad03.html?___from_store=bolt"
                         ...
                         <!-- <div class="dropdown block-currency-wrapper">
                             ...
                             <ul role="menu" class="dropdown-menu">
                                 ...
                                 <li role="presentation"><a
                                         href="directory/currency/switch/currency/EGP/uenc/aHR0cDovL21hczEubWFnaWt0aGVtZXMuY29tL2luZGV4LnBocC9ib2x0Lw%2c%2c/index3945.html?___store=EGP"
                                         tabindex="-1" role="menuitem" title="EGP"> £ - EGP</a></li>

                                 <li role="presentation"><a
                                         href="directory/currency/switch/currency/EUR/uenc/aHR0cDovL21hczEubWFnaWt0aGVtZXMuY29tL2luZGV4LnBocC9ib2x0Lw%2c%2c/indexd4fa.html?___store=EUR"
                             ...
                             <div class="links">
                                 ...
                                 <div class="dropdown block-company-wrapper hidden-xs"> <a href="#"
                                     ...
                                     <ul class="dropdown-menu">
                                         <li role="presentation"><a title="About Us" href="about-us/index.html"> About
                                                 Us </a></li>
                                         <li role="presentation"><a title="Customer Service" href="#"> Customer Service
                                             </a></li>
                                         <li role="presentation"><a title="Privacy Policy" href="#"> Privacy Policy </a>
                                         </li>
                                         <li role="presentation"><a title="Site Map"
                                                 href="catalog/seo_sitemap/category/index.html">Site Map </a></li>
                                         <li role="presentation"><a title="Search Terms"
                                                 href="catalogsearch/term/popular/index.html">Search Terms </a></li>
                                 ...
                                 <div class="login"><a href="{{ route('user.login.form') }}" title="Log In"><span
                                     ...
                                     @else
                                     <div class="login"><a href="{{ route('user.logout') }}" title="Log In"><span
                 ...
                 <div class="container">
                     <div class="row">
                         ...
                         <div class="col-lg-6 col-md-4 col-sm-4 col-xs-12 logo-block">
                             ...
                             <div class="logo">
                                 <!-- For version 1 -->
                                 <a href="/" title="Magento Commerce">
                                     <div><img style="width:35%;" src="{{ asset('user/images/tetra_smart5.png') }}"
                                             alt="Bolt Store" /></div>
                                 </a>
                             </div>
                             <!--logo-->
                                     ...
                                     <div class="basket">
                                         <a href="{{ route('cart.view') }}">
                                             ...
                                             <span class="price">My Cart / <span
                                                     class="price">{{session()->get('cart')->total_price}}/=</span></span>
